#Team Note: here is the fixed version. You are free to use Chatgpt for any issue
...
cap = cv2.VideoCapture(0)  # If you get any issues when connecting the camera, please tell me
...
while cap.isOpened():
    ...
    # Fixed the error in findContours
